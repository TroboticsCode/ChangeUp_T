...
void userDrive(void)
{
  ...
  int32_t verticalAxis = Controller1.VERTICALAXIS.value();
    ...
    BackRight.spin(directionType::fwd, (verticalAxis - (0.66 * horizontalAxis)), velocityUnits::pct);
    BackLeft.spin(directionType::fwd, (verticalAxis + (0.66 * horizontalAxis)), velocityUnits::pct);
    FrontRight.spin(directionType::fwd, (verticalAxis - (0.66 * horizontalAxis)), velocityUnits::pct);
    FrontLeft.spin(directionType::fwd, (verticalAxis + (0.66 * horizontalAxis)), velocityUnits::pct);
  #endif
